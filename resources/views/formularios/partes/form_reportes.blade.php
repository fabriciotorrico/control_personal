              ...
              <div class="col-sm-8 col-sm-offset-2 myform-cont" >
                 ...
                 <div class="myform-top">
                    <div class="myform-top-left">
                      ...
                      <h3>Reportes	</h3>
                        <p>Por favor seleccione el reporte que desea imprimir</p>
                    </div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="myform-bottom">
											<form action="{{ url('form_parte_igm') }}"  method="post">
												...
												<button type="submit" style="font-size: 16px; padding: 30px;width: 100%; background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#87CEEB), color-stop(100%,#4682B4)); -webkit-box-shadow: inset 0px 0px 6px #fff; border-radius: 10px;">
													<div class="">
														<div class="">
															<span  style='font-size: 20px; color:black; height: 50px; font-weight:bold; text-align:center' class="">Parte IGM</span>
															<br>
											...
											<form action="{{ url('form_parte_por_departamento') }}"  method="post">
												<input type="hidden" name="" value="">
												<br>
												<button type="submit" style="font-size: 16px; padding: 30px;width: 100%; background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#87CEEB), color-stop(100%,#4682B4)); -webkit-box-shadow: inset 0px 0px 6px #fff; border-radius: 10px;">
													<div class="">
														<div class="">
															<span  style='font-size: 20px; color:black; height: 50px; font-weight:bold; text-align:center' class="">Parte por Departamento</span>
															<br>
															<!--span class="info-box-number">Cultivos Asociados al Café</span-->
														</div>
													</div>
